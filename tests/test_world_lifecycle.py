...
def test_current_image_world_parses_with_all_bosses(server: Server) -> None:
    ...
    actual Terraria version, so a format change from a Renovate bump fails here even if the committed
    fixture is stale. Regenerate that fixture with `task fixture:world`."""
